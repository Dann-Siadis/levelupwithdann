...
export const metadata: Metadata = { title: 'Kickboxing — LevelUpWithDann' }

export default async function KickboxingPage() {
  const posts = await client.fetch(`
    *[_type == "post" && category == "kickboxing"] | order(publishedAt desc){
  ...
  return (
    <div className="max-w-6xl mx-auto px-5 py-10">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold text-white">Kickboxing</h1>
